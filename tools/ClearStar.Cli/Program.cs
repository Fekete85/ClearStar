...
foreach (var entry in wf.Steps)
{
    ...
    if (img is not null && entry.Id is StepId.Stack or StepId.BackgroundExtraction or StepId.Deconvolution or StepId.Denoise or StepId.ColorCalibration or StepId.StarRemoval or StepId.StarlessStretch or StepId.StarStretch or StepId.Saturation)
    {
